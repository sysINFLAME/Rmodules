...
@Component
@Scope('prototype')
class PhenomapMultiCategoricalClinicalVariableColumnConfigurator extends ColumnConfigurator {
...
//			println it
		...
		println ("variablesvariablesvariables " + variables)
		...
		println 'clinicalVariables ' + variableToGroupName
		println 'header ' + header

        table.addColumn(
                decorateColumn.call(
                        new CategoricalVariableColumn(
                                leafNodes: variableToGroupName,
                                header:            header)),
